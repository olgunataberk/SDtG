...
public class SdtgParser extends Parser {
    ...
    public static final int RULE_game = 0, RULE_declarationSection = 1, RULE_identifierList = 2, RULE_scriptSection = 3,
            RULE_textLineList = 4, RULE_textLine = 5, RULE_textBlock = 6, RULE_line = 7, RULE_choicePrompt = 8,
            RULE_choiceList = 9, RULE_choiceExpression = 10, RULE_karmaOperationList = 11, RULE_karmaOperation = 12,
            RULE_karmaExpression = 13, RULE_karmaTerm = 14, RULE_karmaFactor = 15, RULE_karmaPrimary = 16,
            RULE_karmaPredicate = 17;
    public static final String[] ruleNames = { "game", "declarationSection", "identifierList", "scriptSection",
            "textLineList", "textLine", "textBlock", "line", "choicePrompt", "choiceList", "choiceExpression",
            "karmaOperationList", "karmaOperation", "karmaExpression", "karmaTerm", "karmaFactor", "karmaPrimary",
            "karmaPredicate" };
    ...
    public static class DeclarationSectionContext extends ParserRuleContext {
        public TerminalNode DeclarationStart()
        {
            return getToken(SdtgParser.DeclarationStart, 0);
        }

        public TerminalNode LP()
        {
            return getToken(SdtgParser.LP, 0);
        }
        ...
        {
            return getToken(SdtgParser.RP, 0);
        }

        public TerminalNode End()
        {
            return getToken(SdtgParser.End, 0);
        }
    ...
    public static class IdentifierListContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.Identifier, 0);
        }
    ...
    public static class ScriptSectionContext extends ParserRuleContext {
        public TerminalNode ScriptStart()
        {
            return getToken(SdtgParser.ScriptStart, 0);
        }
    ...
    public static class RegularTextLineContext extends TextLineContext {
        ...
        public RegularTextLineContext(TextLineContext ctx)
        {
            copyFrom(ctx);
        }
    ...
    public static class ConditionalTextLineContext extends TextLineContext {
        ...
        public ConditionalTextLineContext(TextLineContext ctx)
        {
            copyFrom(ctx);
        }
    ...
    public static class LineContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.String, 0);
        }
    ...
    public static class ChoicePromptContext extends ParserRuleContext {
        public TerminalNode ChoiceStart()
        {
            return getToken(SdtgParser.ChoiceStart, 0);
        }
        ...
        public TerminalNode ChoiceEnd()
        {
            return getToken(SdtgParser.ChoiceEnd, 0);
        }
    ...
    public static class KarmaOperationListContext extends ParserRuleContext {
        ...
        public int getRuleIndex()
        {
            return RULE_karmaOperationList;
        }
    ...
    public static class KarmaOperationContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.Operator, 0);
        }

        public TerminalNode Integer()
        {
            return getToken(SdtgParser.Integer, 0);
        }
    ...
    public static class KarmaExpressionContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.Or, 0);
        }
    ...
    public static class KarmaTermContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.And, 0);
        }
    ...
    public static class KarmaFactorContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.Not, 0);
        }
    ...
    public static class KarmaPredicateContext extends ParserRuleContext {
        ...
        {
            return getToken(SdtgParser.RelationalOperator, 0);
        }
